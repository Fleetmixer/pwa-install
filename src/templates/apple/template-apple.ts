                ...
                <div class="how-to-body">
                    <div class="how-to-description">
                        <div class="description-step">
                            ...
                            <div class="step-text">${msg('2) Press Share in Navigation bar').replace(isDesktop? '2)': '2)', '1)')}</div>
                        </div>
                        <div class="description-step">
                            <div class="svg-wrap">
                                ${isDesktop? 
                            ...
                            <div class="step-text">${isDesktop? msg('2) Press Add to Dock'): msg('3) Scroll down to "Add to Home Screen"').replace('3)', '2)')}</div>
                        </div>
                    </div>
                </div>
